...
Fork, then clone the repo:
    ...
    git clone git@github.com:your-username/rocksmith-plus-tools.git

**All changes should be based from the `main` branch.**

Push to your fork and [submit a pull request](https://github.com/notmyself/rocksmith-plus-tools/compare/) against the `main` branch.
